...
class Servico(models.Model):
    ...
    valor = models.DecimalField(max_digits=6,decimal_places=2,verbose_name="Preço do Serviço")
...
class Agendamento(models.Model):
    ...
    def hora_fim(self):
        if self.data_hora:
            return self.data_hora + timedelta(minutes=self.duracao_total_minutos)
        return None
